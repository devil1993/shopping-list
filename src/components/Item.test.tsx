...
describe("Item component", () => {
    ...
    describe("Behavior tests - ", () => {
        ...
        it("Should not display any button when done is clicked for checked out item", () =>{
            let user = new User("junkUserId")
            let item = new ItemModel(user)
            item.name = "ItemName"
            item.checkedOut = true;
            ...
            expect(undoButton).toBeInTheDocument();
            let doneButton = screen.queryByRole('button', {
                name: 'Done'
            });
            ...
            doneButton = screen.queryByRole('button', {
                name: 'Done'
            })
